                ...
                call.enqueue(object : Callback {
                    ...
                    override fun onResponse(call: Call, response: Response) {
                        ...
                        response.body?.let { responseBody ->
                            ...
                            val naves = gson.fromJson(body, NavesResponse::class.java)
                            ...
                            CoroutineScope(Dispatchers.Main).launch {
                                ...
                                setResponsePelisListInMainThread(naves.results)

                                setResponseTextInMainThread("Hemos obtenido ${naves.results.count()} ")
                            }
                        }
                    }
                })
